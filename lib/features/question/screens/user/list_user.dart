          ...
          child: Column(
            children: [
              Obx(
                () => FutureBuilder(
                  key:
                      Key(classController.refreshListUserData.value.toString()),
                  ...
                  builder: (context, snapshot) {
                    ...
                    return ListView.builder(
                      ...
                      key: Key(
                          classController.refreshListUserData.value.toString()),
                      shrinkWrap: true,
                      physics: const NeverScrollableScrollPhysics(),
                      itemBuilder: (_, index) {
                        if (!classController.usersSelected
                          ...
                          return Row(
                              ...
                              children: [
                                ...
                                IconButton(
                                  ...
                                  onPressed: () => classController
                                      .addUserToClass(users[index], course.id!),
                                )
                              ]);
                        }
                      },
